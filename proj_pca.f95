...
!	  write(*,*)eiglamO(i),order(i)
	...
	CLOSE(30)
        ...
        OPEN(unit=27,file='PC_dev',status='unknown')
        DO a=1,3*n
	...
	CLOSE(11)
	  ...
	  WRITE(aa,*)a
	  aa=adjustl(aa)
	  OPEN(unit=10,file='minframe'//TRIM(aa)//'_LE4PD_noh',status='unknown')
	  OPEN(unit=11,file='maxframe'//TRIM(aa)//'_LE4PD_noh',status='unknown')
	  var=0.0
	  minvar=0.0
	  maxvar=0.0
	  maxframe=0
